...
function(t) {
	...
	var e = function(e) {
			...
			var c = this,
				l = {
					...
					toolbarCloseText: "完成",
					title: "请选择",
					toolbarTemplate: '<div class="toolbar">          <div class="toolbar-inner">          <a href="javascript:;" class="close-pickerBox">取消</a><a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>'
				};
			e = e || {};
  ...
  t(document).on("click", ".close-pickerBox", function() {
		var e = t(".weui-picker-modal.weui-picker-modal-visible");
		e.length > 0 && t.closePicker(e)
	}),
	t(document).on("click", ".close-picker", function() {
		var e = t(".weui-picker-modal.weui-picker-modal-visible");
    var provinceId = $('.picker-modal-inner .col-province .picker-item.picker-selected').attr('data-picker-value');
    var cityId = $('.picker-modal-inner .col-city .picker-item.picker-selected').attr('data-picker-value');
    var districtId = $('.picker-modal-inner .col-district .picker-item.picker-selected').attr('data-picker-value');

    var provinceText = $('.picker-modal-inner .col-province .picker-item.picker-selected').text();
    var cityText= $('.picker-modal-inner .col-city .picker-item.picker-selected').text();
    var districtText = $('.picker-modal-inner .col-district .picker-item.picker-selected').text();

    $('#city-picker').attr('data-province',provinceId)
    $('#city-picker').attr('data-city',cityId)
    $('#city-picker').attr('data-districtId',districtId)
    $('#city-picker').val(provinceText +  " " + cityText + " " + districtText)
    e.length > 0 && t.closePicker(e)
